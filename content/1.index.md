...
- Use [layouts](https://nuxt.com/docs/guide/directory-structure/layouts) in Markdown pagesGenerated navigation from pages
- Leverage TailwindCSS Typography
- Create Vue components and use them in MarkdownSwitch between light & dark mode
